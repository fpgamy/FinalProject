...
//  Generated date: Tue May 03 16:03:18 2016
// ----------------------------------------------------------------------

// 
// ------------------------------------------------------------------
//  Design Unit:    pixel_detect_2_core_fsm
//  FSM Module
// ------------------------------------------------------------------


module pixel_detect_2_core_fsm (
  clk, rst, fsm_output
);
  input clk;
  input rst;
  ...
  // FSM State Type Declaration for pixel_detect_2_core_fsm_1
  parameter
    st_main = 1'd0,
    st_main_1 = 1'd1,
    state_x = 1'b0;
  ...
  always @(*)
  begin : pixel_detect_2_core_fsm_1
    case (state_var)
      st_main : begin
        fsm_output = 2'b1;
...
// ------------------------------------------------------------------
//  Design Unit:    pixel_detect_2_core
// ------------------------------------------------------------------


module pixel_detect_2_core (
  ...
  // Interconnect Declarations for Component Instantiations 
  pixel_detect_2_core_fsm pixel_detect_2_core_fsm_inst (
      .clk(clk),
      .rst(rst),
  ...
  assign or_3_cse = (~((fsm_output[0]) & (readslicef_11_1_10((({1'b1 , (~ (video_in_rsc_mgc_in_wire_d[29:20]))})
      ...
      + 10'b1111110001)))) | (readslicef_11_1_10((conv_u2s_10_11(vga_xy_rsc_mgc_in_wire_d[9:0])
      + 11'b11000110001)));
  always @(posedge clk) begin
    if ( rst ) begin
...
// ------------------------------------------------------------------
//  Design Unit:    pixel_detect_2
//  Generated from file(s):
//    8) //icnas2.cc.ic.ac.uk/dm2515/FinalEIEProject/pixel_detect_2/vga_mouse.cpp
// ------------------------------------------------------------------


module pixel_detect_2 (
  ...
  pixel_detect_2_core pixel_detect_2_core_inst (
      .clk(clk),
      .rst(rst),
