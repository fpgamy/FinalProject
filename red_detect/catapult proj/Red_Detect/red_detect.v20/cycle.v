...
//  Generated date: Sat May 07 15:46:18 2016
// ----------------------------------------------------------------------
    ...
    begin : mainExit
      forever begin : main
        ...
        slc_svs = readslicef_11_1_10((({1'b1 , (~ (io_read_video_in_rsc_d_cse_sva[29:20]))})
            + 11'b11001001));
        if ( slc_svs ) begin
          land_1_sva_1 = readslicef_8_1_7((conv_u2u_7_8(io_read_video_in_rsc_d_cse_sva[9:3])
              + 8'b11100111));
        end
        land_1_lpi_dfm = land_1_sva_1 & slc_svs;
        if ( land_1_lpi_dfm ) begin
          land_sva_1 = readslicef_8_1_7((conv_u2u_7_8(io_read_video_in_rsc_d_cse_sva[19:13])
              + 8'b11100111));
        end
