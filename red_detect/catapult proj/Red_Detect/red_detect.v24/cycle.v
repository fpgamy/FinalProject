...
//  Generated date: Sun May 08 13:37:24 2016
// ----------------------------------------------------------------------
    ...
    begin : mainExit
      forever begin : main
        ...
        slc_svs = readslicef_11_1_10((({1'b1 , (~ (io_read_video_in_rsc_d_cse_sva[29:20]))})
            + 11'b1001011001));
        if ( slc_svs ) begin
          land_1_sva_1 = readslicef_10_1_9((conv_u2u_9_10(io_read_video_in_rsc_d_cse_sva[9:1])
              + 10'b1100011111));
        end
        land_1_lpi_dfm = land_1_sva_1 & slc_svs;
        if ( land_1_lpi_dfm ) begin
          land_sva_1 = readslicef_10_1_9((conv_u2u_9_10(io_read_video_in_rsc_d_cse_sva[19:11])
              + 10'b1100011111));
        end
        ...
        mux_1_nl = MUX_v_10_2_2({(io_read_video_in_rsc_d_cse_sva[19:10]) , 10'b1000000000},
            land_lpi_dfm);
        video_out_rsc_mgc_out_stdreg_d <= {((io_read_video_in_rsc_d_cse_sva[29:20])
            | ({{9{land_lpi_dfm}}, land_lpi_dfm})) , (mux_1_nl) , ((io_read_video_in_rsc_d_cse_sva[9:0])
