...
//  Generated date: Thu May 12 13:44:43 2016
// ----------------------------------------------------------------------
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( slc_svs ) begin
              land_2_sva_1 = readslicef_12_1_11((({1'b1 , slc_x_top_left_cse_sva
            ...
            land_lpi_1_dfm = ~(went_through_1_sva_dfm | (~(aif_1_land_sva_1 & aif_1_slc_svs
                & land_2_lpi_1_dfm)));
            ...
            if_5_acc_cse_sg1 = readslicef_12_1_11((conv_u2u_11_12(readslicef_12_11_1((conv_u2u_11_12({if_1_io_read_height_rsc_d_ncse_sva
                , 1'b1}) + conv_u2u_11_12({(~ (io_read_vga_xy_rsc_d_cse_sva[19:10]))
                , 1'b1})))) + conv_s2u_11_12({1'b1 , if_1_io_read_y_top_left_rsc_d_ncse_sva})));
            went_through_1_sva = went_through_1_sva_dfm | if_5_acc_cse_sg1;
            begin : waitLoop1Exit
            ...
            land_3_lpi_1_dfm = ~(went_through_1_sva_dfm | (~(if_5_acc_cse_sg1 & (readslicef_29_1_28((conv_s2u_28_29(~
                (counter_sva_dfm_2[31:4])) + 29'b11001))))));
            if ( land_3_lpi_1_dfm ) begin
            end
            else begin
              else_2_land_lpi_1_dfm = ~(went_through_1_sva_dfm | (~(if_5_acc_cse_sg1
