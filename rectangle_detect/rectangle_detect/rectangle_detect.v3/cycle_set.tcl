...
directive set /rectangle_detect/core/core:rlp/main CSTEPS_FROM {{. == 3} {.. == 0}}
...
directive set /rectangle_detect/core/core:rlp/main/io_write(filled:rsc.d) CSTEPS_FROM {{.. == 2}}
directive set /rectangle_detect/core/core:rlp/main/io_write(video_out:rsc.d) CSTEPS_FROM {{.. == 1}}
...
directive set /rectangle_detect/core/core:rlp/main/acc#7 CSTEPS_FROM {{.. == 1}}
directive set /rectangle_detect/core/core:rlp/main/acc#8 CSTEPS_FROM {{.. == 1}}
...
directive set /rectangle_detect/core/core:rlp/main/mux#2 CSTEPS_FROM {{.. == 2}}
...
directive set /rectangle_detect/core/core:rlp/main/else#2:if:acc CSTEPS_FROM {{.. == 2}}
directive set /rectangle_detect/core/core:rlp/main/else#2:if:acc#2 CSTEPS_FROM {{.. == 2}}
directive set /rectangle_detect/core/core:rlp/main/else#2:if:acc#1 CSTEPS_FROM {{.. == 2}}
...
directive set /rectangle_detect/core/core:rlp/main/mux#5 CSTEPS_FROM {{.. == 1}}
directive set /rectangle_detect/core/core:rlp/main/if#5:acc#1 CSTEPS_FROM {{.. == 1}}
directive set /rectangle_detect/core/core:rlp/main/if#5:acc CSTEPS_FROM {{.. == 1}}
