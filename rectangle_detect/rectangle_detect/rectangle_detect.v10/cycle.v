...
//  Generated date: Thu May 12 14:23:06 2016
// ----------------------------------------------------------------------
...
module rectangle_detect_core (
  ...
  begin : core
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( land_lpi_1_dfm ) begin
              if_1_slc_svs = readslicef_10_1_9(((readslicef_12_10_2((conv_u2u_11_12(conv_u2u_10_11(io_read_video_in_rsc_d_cse_sva[9:0])
                  + conv_u2u_10_11(io_read_video_in_rsc_d_cse_sva[19:10])) + conv_u2u_10_12(io_read_video_in_rsc_d_cse_sva[29:20]))))
                  + 10'b1010001001));
            end
            ...
            if ( land_2_lpi_1_dfm ) begin
              ...
              else_2_slc_svs = readslicef_29_1_28((conv_s2u_28_29(counter_sva_dfm_2[31:4])
            ...
            if ( land_2_lpi_1_dfm ) begin
              ...
              if ( else_2_slc_svs ) begin
                else_2_if_acc_1_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({y_top_left_rsc_mgc_in_wire_d
                    , 1'b1}) + conv_u2u_11_12({height_rsc_mgc_in_wire_d , 1'b1})));
                else_2_land_1_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[19:10]) !=
                    (else_2_if_acc_1_sdt_sva[9:0])) | (else_2_if_acc_1_sdt_sva[10]));
              end
              else_2_land_1_lpi_1_dfm = else_2_land_1_sva_1 & else_2_slc_svs;
              if ( else_2_land_1_lpi_1_dfm ) begin
                else_2_if_acc_2_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({slc_x_top_left_cse_sva
                    , 1'b1}) + conv_u2u_11_12({slc_width_cse_sva , 1'b1})));
                else_2_land_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[9:0]) != (else_2_if_acc_2_sdt_sva[9:0]))
                    | (else_2_if_acc_2_sdt_sva[10]));
              end
              else_2_land_lpi_1_dfm = else_2_land_sva_1 & else_2_land_1_lpi_1_dfm;
            end
            static_fill_1_sva_dfm_1 = (static_fill_1_sva & (~ else_2_land_lpi_1_dfm))
                | land_2_lpi_1_dfm;
            filled_rsc_mgc_out_stdreg_d <= static_fill_1_sva_dfm_1;
            video_out_rsc_mgc_out_stdreg_d <= {mux_2_itm , mux_3_itm , mux_4_itm};
            static_fill_1_sva = static_fill_1_sva_dfm_1;
            begin : waitLoop3Exit
    ...
    mux_2_itm = 10'b0;
    and_1_itm = 1'b0;
    static_fill_1_sva_dfm_1 = 1'b0;
    else_2_land_lpi_1_dfm = 1'b0;
    else_2_land_sva_1 = 1'b0;
    else_2_if_acc_2_sdt_sva = 11'b0;
    else_2_land_1_lpi_1_dfm = 1'b0;
    else_2_land_1_sva_1 = 1'b0;
    else_2_if_acc_1_sdt_sva = 11'b0;
    else_2_slc_svs = 1'b0;
