...
//  Generated date: Thu May 12 14:36:29 2016
// ----------------------------------------------------------------------
...
module rectangle_detect_core (
  ...
  begin : core
    ...
    reg else_2_slc_svs;
    reg [10:0] else_2_if_acc_sdt_sva;
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            slc_1_svs = readslicef_33_1_32((conv_s2u_32_33(~ counter_sva_dfm_2) +
                33'b1100100001));
            if ( slc_1_svs ) begin
              if_3_acc_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({y_top_left_rsc_mgc_in_wire_d
                  , 1'b1}) + conv_u2u_11_12({height_rsc_mgc_in_wire_d , 1'b1})));
              land_3_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[19:10]) != (if_3_acc_sdt_sva[9:0]))
                  | (if_3_acc_sdt_sva[10]));
            end
            land_3_lpi_1_dfm = land_3_sva_1 & slc_1_svs;
            if ( land_3_lpi_1_dfm ) begin
              if_3_acc_1_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({slc_x_top_left_cse_sva
                  , 1'b1}) + conv_u2u_11_12({slc_width_cse_sva , 1'b1})));
              land_2_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[9:0]) != (if_3_acc_1_sdt_sva[9:0]))
            ...
            if ( land_2_lpi_1_dfm ) begin
              ...
              else_2_slc_svs = readslicef_33_1_32((conv_s2u_32_33(counter_sva_dfm_2)
            ...
            if ( land_2_lpi_1_dfm ) begin
              ...
              if ( else_2_slc_svs ) begin
                else_2_if_acc_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({y_top_left_rsc_mgc_in_wire_d
                    , 1'b1}) + conv_u2u_11_12({height_rsc_mgc_in_wire_d , 1'b1})));
                else_2_land_1_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[19:10]) !=
                    (else_2_if_acc_sdt_sva[9:0])) | (else_2_if_acc_sdt_sva[10]));
              end
              else_2_land_1_lpi_1_dfm = else_2_land_1_sva_1 & else_2_slc_svs;
              if ( else_2_land_1_lpi_1_dfm ) begin
                else_2_if_acc_1_sdt_sva = readslicef_12_11_1((conv_u2u_11_12({slc_x_top_left_cse_sva
                    , 1'b1}) + conv_u2u_11_12({slc_width_cse_sva , 1'b1})));
                else_2_land_sva_1 = ~(((io_read_vga_xy_rsc_d_cse_sva[9:0]) != (else_2_if_acc_1_sdt_sva[9:0]))
                    | (else_2_if_acc_1_sdt_sva[10]));
              end
