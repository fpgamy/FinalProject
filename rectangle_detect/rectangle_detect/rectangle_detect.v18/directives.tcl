...
//  
//  Running on Windows 7 mg3115@EEWS104A-007 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {./rectangle_detect.c} -type C++
...
directive set -DESIGN_HIERARCHY rectangle_detect
go compile
directive set /get_square_intensity/core/main -MERGEABLE true
...
directive set /get_square_intensity/core/main -DISTRIBUTED_PIPELINE false
directive set /get_square_intensity/core/main -PIPELINE_INIT_INTERVAL 0
go architect
go extract
