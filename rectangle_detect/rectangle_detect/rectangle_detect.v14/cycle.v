...
//  Generated date: Thu May 12 15:20:22 2016
// ----------------------------------------------------------------------
        ...
        begin : mainExit
          forever begin : main
            ...
            slc_1_svs = readslicef_33_1_32((conv_s2u_32_33(~ counter_sva_dfm_2) +
                33'b1100100001));
            if ( slc_1_svs ) begin
              land_3_sva_1 = readslicef_12_1_11((conv_u2u_11_12(readslicef_12_11_1((conv_u2u_11_12({height_rsc_mgc_in_wire_d
                  , 1'b1}) + conv_u2u_11_12({(~ (io_read_vga_xy_rsc_d_cse_sva[19:10]))
                  , 1'b1})))) + conv_s2u_11_12({1'b1 , y_top_left_rsc_mgc_in_wire_d})));
            end
            land_3_lpi_1_dfm = land_3_sva_1 & slc_1_svs;
            if ( land_3_lpi_1_dfm ) begin
              land_2_sva_1 = readslicef_12_1_11((conv_u2u_11_12(readslicef_12_11_1((conv_u2u_11_12({slc_width_cse_sva
                  , 1'b1}) + conv_u2u_11_12({(~ (io_read_vga_xy_rsc_d_cse_sva[9:0]))
            ...
            if ( land_2_lpi_1_dfm ) begin
              ...
              if ( else_2_slc_svs ) begin
                else_2_land_1_sva_1 = readslicef_12_1_11((conv_u2u_11_12(readslicef_12_11_1((conv_u2u_11_12({height_rsc_mgc_in_wire_d
                    , 1'b1}) + conv_u2u_11_12({(~ (io_read_vga_xy_rsc_d_cse_sva[19:10]))
                    , 1'b1})))) + conv_s2u_11_12({1'b1 , y_top_left_rsc_mgc_in_wire_d})));
              end
              else_2_land_1_lpi_1_dfm = else_2_land_1_sva_1 & else_2_slc_svs;
              if ( else_2_land_1_lpi_1_dfm ) begin
                else_2_land_sva_1 = readslicef_12_1_11((conv_u2u_11_12(readslicef_12_11_1((conv_u2u_11_12({slc_width_cse_sva
                    , 1'b1}) + conv_u2u_11_12({(~ (io_read_vga_xy_rsc_d_cse_sva[9:0]))
                    , 1'b1})))) + conv_s2u_11_12({1'b1 , slc_x_top_left_cse_sva})));
              end
              else_2_land_lpi_1_dfm = else_2_land_sva_1 & else_2_land_1_lpi_1_dfm;
              counter_sva_dfm_3 = counter_sva_dfm_2 & (signext_32_1(~ else_2_land_lpi_1_dfm));
            end
            ...
            counter_sva = MUX_v_32_2_2({counter_sva_dfm_3 , 32'b1100100001}, land_2_lpi_1_dfm);
