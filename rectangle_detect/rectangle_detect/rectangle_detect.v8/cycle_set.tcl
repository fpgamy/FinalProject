...
directive set /rectangle_detect/core/core:rlp/main/acc#6 CSTEPS_FROM {{.. == 1}}
...
directive set /rectangle_detect/core/core:rlp/main/if#3:unequal CSTEPS_FROM {{.. == 2}}
directive set /rectangle_detect/core/core:rlp/main/if#3:acc#4 CSTEPS_FROM {{.. == 2}}
directive set /rectangle_detect/core/core:rlp/main/if#3:unequal#1 CSTEPS_FROM {{.. == 2}}
...
directive set /rectangle_detect/core/core:rlp/main/else#2:if:unequal CSTEPS_FROM {{.. == 3}}
directive set /rectangle_detect/core/core:rlp/main/else#2:if:acc#4 CSTEPS_FROM {{.. == 3}}
directive set /rectangle_detect/core/core:rlp/main/else#2:if:unequal#1 CSTEPS_FROM {{.. == 3}}
