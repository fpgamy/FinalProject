...
//  
//  Running on Windows 7 ymh15@EEWS104A-009 Service Pack 1 6.01.7601 i686
//  
...
//  
project new
solution file add {../get_square_intensity.cpp} -type C++
...
directive set -DESIGN_HIERARCHY get_square_intensity
go compile
directive set /get_square_intensity/core/main -DISTRIBUTED_PIPELINE true
directive set /get_square_intensity/core/main -PIPELINE_INIT_INTERVAL 1
directive set /get_square_intensity/height -STREAM 10
directive set /get_square_intensity/width -STREAM 10
directive set /get_square_intensity/y_top_left -STREAM 10
directive set /get_square_intensity/x_top_left -STREAM 10
directive set /get_square_intensity/last_pixel -STREAM 0
directive set /get_square_intensity/intensity_out -STREAM 10
directive set /get_square_intensity/video_in -STREAM 30
directive set /get_square_intensity/vga_xy -STREAM 20
go architect
go extract
