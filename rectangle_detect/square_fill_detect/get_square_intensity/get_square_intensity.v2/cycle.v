...
//  Generated date: Sat May 07 12:03:47 2016
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        if_slc_mdf_sva = 1'b0;
        if ( land_lpi_dfm ) begin
          if_slc_mdf_sva = readslicef_11_1_10((({1'b1 , (~ (readslicef_11_10_1((({(acc_idiv_sva[11])
        ...
        C1_1_dfmergedata_lpi_dfm_1 = (C1_1_dfmergedata_lpi_dfm_1 | if_slc_mdf_sva)
            & land_lpi_dfm;
        if ( if_slc_mdf_sva | (~ land_lpi_dfm) ) begin
          white_or_not_rsc_mgc_out_stdreg_d <= C1_1_dfmergedata_lpi_dfm_1;
        end
        begin : waitLoop2Exit
