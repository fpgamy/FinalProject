...
directive set /get_square_intensity/core/main/h:io_read(height:rsc.d) CSTEPS_FROM {{.. == 1}}
directive set /get_square_intensity/core/main/io_read(vga_xy:rsc.d) CSTEPS_FROM {{.. == 1}}
directive set /get_square_intensity/core/main/ytl:io_read(y_top_left:rsc.d) CSTEPS_FROM {{.. == 1}}
